...
namespace SimpleTracker
{
  internal class Program
  {
    ...
    private static Tracker InitTracker()
    {
      ...
      Program.Logger.Log(string.Format("GAME_CLIENT_VERSION: {0}, Arena type: {1}", (object) str, (object) arenaType));
      ...
      return new Tracker((IDiscordMessenger) new DiscordMessenger(webHook), playerSettingsProvider, (IArenaRankStorage) new StaticArenaRankStorage(), (IPlayerRankService) new PlayerRankService((IGameClient) new Ipd.GameClient.GameClient()
      {
