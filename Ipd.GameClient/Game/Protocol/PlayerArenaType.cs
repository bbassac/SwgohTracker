...
// Type: Ipd.Game.Protocol.PlayerArenaType
...
namespace Ipd.Game.Protocol
{
  ...
  {
    [OriginalName("PlayerArena_None")] PlayerArenaNone,
    [OriginalName("SquadArena")] SquadArena,
    [OriginalName("FleetArena")] FleetArena,
  }
}
