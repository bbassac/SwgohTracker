...
namespace Ipd.Game.Protocol
{
  ...
  {
    private static readonly MessageParser<PlayerProfileRequest> _parser = new MessageParser<PlayerProfileRequest>((Func<PlayerProfileRequest>) (() => new PlayerProfileRequest()));
    ...
    [DebuggerNonUserCode]
    public static MessageParser<PlayerProfileRequest> Parser => PlayerProfileRequest._parser;

    [DebuggerNonUserCode]
    public static MessageDescriptor Descriptor => PlayerProfileRequestReflection.Descriptor.MessageTypes[0];

    [DebuggerNonUserCode]
    MessageDescriptor IMessage.pb\u003A\u003AGoogle\u002EProtobuf\u002EIMessage\u002EDescriptor => PlayerProfileRequest.Descriptor;
    ...
    [DebuggerNonUserCode]
    public PlayerProfileRequest Clone() => new PlayerProfileRequest(this);
    ...
    [DebuggerNonUserCode]
    public override bool Equals(object other) => this.Equals(other as PlayerProfileRequest);
